...
async function updateData(dateRange) {
    try {
        ...
        const response = await axios.get(`http://35.154.167.41:3000/expenses/for-report/${dateRange}`, {headers: {"Authorization": token}});
...
async function downloadExpenses() {
    try {
        ...
        const response = await axios.get("http://35.154.167.41:3000/expenses/download", {headers: {"Authorization": token}});
...
async function getExpensesUrls(){
    try {
        ...
        const response = await axios.get(`http://35.154.167.41:3000/expenses/file-urls`, {headers: {"Authorization": token}});
